...
<section>
 ...
 <h1 className="">Employee Benefits
  </h1>
  <p className="report-benefits">
  EVEREST Global Solutions takes pleasure in making its Work Place best for its employees. We follow a culture of work together for Company 
Benefits, which makes every employee, a part and parcel of EVEREST Global Solutions. Our Employee Benefit scheme is designed to make job 
most delightful and satisfying. We serve our employees with the Attractive Compensation and Perks as per their job standards. We provide 
training to our employees in order to enhance their professional and personal skill sets. Every year special Training Programs are 
designed for EVEREST Global Solutions Technology staff to provide them the right skills and motivations at the right time.
   </p>
 </div>
 </div>
  </section>
...
<section>
 ...
 <h1 className="">Mission Statement
  ...
  <p className="report-benefits">
  EVEREST Global Solutions is committed to being the highest quality supplier of employment solutions to its clients. Our mission is to provide 
best staffing services for our clients and our technical consultants. We believe in equipping our staff with the skills needed to accommodate the 
ever changing needs of today’s business. We will provide the best working place for our employees which will encourage personal and professional 
growth. Our mission is to provide innovative and exclusive Staffing solutions to our valuable clients as well as to place best IT Professionals’ 
at most suited positions in best working environments as per their skill sets.
   </p>
 </div>
 <div className="report-benefits">
  <img
