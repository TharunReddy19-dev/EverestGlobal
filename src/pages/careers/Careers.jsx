...
const Careers = () => {
  ...
  const career = [
    {
      ...
      description:
        "Lead team of Oracle Fusion Cloud HCM developers. Design & architect Cloud HCM solutions.",
      location:
        "Miami, FL area (Travel/relocate to various unanticipated U.S. locations as telecommuting required)",
      salary: "$149,781 per year",
      contact:
        "Send resume to Everest Global Solutions Inc at: gupta@everestglobalsolutionsinc.com",
    ...
    },
    {
      ...
      description:
        "Leverage LeanIX to analyze, consolidate & validate app landscape. Some job duties can be performed from home.",
      location:
        "Miami, FL area (Travel/relocate to various unanticipated U.S. locations as required)",
    ...
    },
    {
      ...
      description:
        "Lead team of Salesforce developers providing technical guidance, mentoring & code reviews. Design and architect Salesforce solutions.",
      location:
        "Miami, FL area (Travel/relocate to various unanticipated U.S. locations as required)",
  ...
  return (
    <>
      ...
      <section className="careers-hero">
        <div className="careers-content">
          ...
          <p className="careers-subheading">
            Explore exciting career opportunities in I.T. and Systems
            Engineering
          </p>
        </div>
      </section>
      ...
      {selectedJob && (
        <SoftwareDeveloperNxt
          job={selectedJob}
          onFinish={() => setSelectedJob(null)}
        />
      )}
    </>
  );
